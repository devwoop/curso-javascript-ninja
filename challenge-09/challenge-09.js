(function () {
    ...
    */
    function myFunction() {
        var number1 = 10; // para resolver o problema acima a variável foi movida para o início do escopo da função.
        var number2 = 20; // para resolver o problema acima a variável foi movida para o início do escopo da função.
    ...
    */
    function myFunction3() {
        function sum() {
            return number1 + number2;
        } // para resolver o problema acima a função foi movida para o início do escopo da função, simulando hoisting.
        var number1 = 40; // para resolver o problema acima a variável foi movida para o início do escopo da função.
        var number2 = 50; // para resolver o problema acima a variável foi movida para o início do escopo da função.
